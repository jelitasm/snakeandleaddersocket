            ...
            while(true){
                ...
                switch(CMD){
                    ...
                    case "CMD_SHARINGSOCKET":
                        main.appendMessage("CMD_SHARINGSOCKET : Client membuat sambungan socket untuk file sharing...");
                        ...
                        main.appendMessage("CMD_SHARINGSOCKET : File sharing terbuka");
                        break;
                    
                    case "CMD_SENDFILE":
                        main.appendMessage("CMD_SENDFILE : Client mengirimkan file...");
                        /*
                        ...
                        */
                        ...
                        main.appendMessage("CMD_SENDFILE : mempersiapkan koneksi..");
                        ...
                        if(cSock != null){ /* Exists   */
                            try {
                                ...
                                main.appendMessage("CMD_SENDFILE : Mengirimkan file ke client...");
                                ...
                                main.appendMessage("CMD_SENDFILE : File telah terkirim ke client...");
                            } catch (IOException e) {
                            ...
                            DataOutputStream dos = new DataOutputStream(socket.getOutputStream());
                            dos.writeUTF("CMD_SENDFILEERROR "+ "Client '"+sendto+"' tidak ditemukan, program ditutup.");
                        }                        
                        break;
